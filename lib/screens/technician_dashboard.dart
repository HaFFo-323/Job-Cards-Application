...
import 'package:flutter_projects/screens/technicians_completed_callouts.dart';
          ...
          child: GridView.count(
              ...
              children: <Widget>[
                Card(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => technician_callouts_view_form()));
                      },
                ...
                Card(
                    ...
                    child: InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => technicians_completed_callouts()));
                      },
                      splashColor: Colors.orange,
                      child: Center(
                        child: Column(
                          ...
                          children: <Widget>[
                            Icon(Icons.work, size: 70.0,),
                            Text("Completed Callouts",style: new TextStyle(fontSize: 17.0),)
                          ],
                        ),
                      ),
                    )
