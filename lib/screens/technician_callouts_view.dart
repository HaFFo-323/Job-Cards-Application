...
class technician_callouts_view_form extends StatefulWidget {
  final String data;
  const technician_callouts_view_form({Key key, this.data}) : super(key: key);

  @override
  _technician_callouts_view_formState createState() => _technician_callouts_view_formState();
}

class _technician_callouts_view_formState extends State<technician_callouts_view_form> {
  ...
  // fetchTechnicianName() async {
  //   dynamic resultant = await DatabaseService().getTechnicianName();
  //
  //   if (resultant == null) {
  ...
  //   CollectionReference collectionReference = FirebaseFirestore.instance.collection('Initial Callout');
          ...
          child: SizedBox(
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context,
                ...
                // else {
                //   return Text('No Callouts for you currently :D',
                //       style: TextStyle(
                //         fontWeight: FontWeight.bold,
                //         fontSize: 20.0,
                //       ),
...
class _callout_detailsState extends State<callout_details> {
  ...
  Future updatedInitialCallout() async {
    ...
    try{
      ...
      initialCalloutData = {
        ...
        'TechnicianUID': widget.details['TechnicianUID'],
        'CustomerUID': widget.details['CustomerUID'],
        //'Completed': completed,
      };

      return initialCallout.add(initialCalloutData).whenComplete(() => print('Updated/Added to Database Successfully'));
  ...
  Future deleteInitialCallout() async {

    var collection = FirebaseFirestore.instance.collection('Initial Callout');
    var snapshot = await collection.where('Reference Number', isEqualTo: widget.details['Reference Number']).get();
                        ...
                        child: new RaisedButton(
                          ...
                          onPressed: () async {
                            if (_formKey.currentState.validate()) {
                              ...
                              //completed = true;
                              dynamic result1 = await UpdateCallout();
                              dynamic result2 = await deleteInitialCallout();
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => technician_Dashboard()));
                              Toast.show(
