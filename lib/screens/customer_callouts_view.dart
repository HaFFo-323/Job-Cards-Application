...
class customer_callouts_view extends StatefulWidget {
  const customer_callouts_view({Key key}) : super(key: key);

  @override
  _customer_callouts_viewState createState() => _customer_callouts_viewState();
}

class _customer_callouts_viewState extends State<customer_callouts_view> {
  ...
  navigateToRatingsPage(Map<String, dynamic> details) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ratings_page(
              details: details,
            )));
  }
                    ...
                    return Padding(
                      ...
                      child: Container(
                        child: ListTile(
                          ...
                          onTap: () => navigateToRatingsPage(data),
                        ),
...
class ratings_page extends StatefulWidget {
  ...
  ratings_page({this.details});

  @override
  _ratings_pageState createState() => _ratings_pageState();
}

// ignore: camel_case_types
class _ratings_pageState extends State<ratings_page> {
                      ...
                      child: new RaisedButton(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState.validate()) {
                            ...
                            Toast.show(
                                "Callout Rated Successfully", context,
